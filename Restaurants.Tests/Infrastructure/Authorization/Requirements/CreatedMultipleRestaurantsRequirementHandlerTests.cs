...
{
    [Fact]
    public async Task HandleRequirementsAsync_UserHasCreatedMultipleRestaurants_ShouldSucceed()
    {
        // Arrange
    ...
    [Fact]
    public async Task HandleRequirementsAsync_UserHasNotCreatedMultipleRestaurants_ShouldFail()
    {
        // Arrange
        var currentUser = new CurrentUser("1", "test@test.com", [], null, null);
        var userContextMock = new Mock<IUserContext>();
